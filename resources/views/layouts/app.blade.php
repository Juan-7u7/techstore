                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center sm:text-left">
                        ...
                        <div class="flex flex-col items-center sm:items-start gap-2">
                            ...
                            <div class="flex flex-col gap-1.5">
                                <a href="{{ route('productos.index') }}" class="text-sm text-muted hover:text-primary transition-colors">Productos</a>
                                <a href="{{ route('dashboard') }}" class="text-sm text-muted hover:text-primary transition-colors">Dashboard</a>
                            </div>
                        </div>
                    </div>

                    <div class="mt-10 pt-6 border-t border-border/30 text-center">
                        <p class="text-xs text-muted/60">Hecho con Laravel, Livewire, Tailwind CSS y React</p>
                    </div>
                </div>
            </footer>
        </div>
